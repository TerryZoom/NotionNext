const CONFIG = {
  // 博客標題 雙語言
  CLAUDE_BLOG_NAME: process.env.NEXT_PUBLIC_CLAUDE_BLOG_NAME || '伊茗雪',
  CLAUDE_BLOG_NAME_EN: process.env.NEXT_PUBLIC_CLAUDE_BLOG_NAME_EN || process.env.NEXT_PUBLIC_CLAUDE_BLOG_NAME || '',
  ...
  CLAUDE_ARTICLE_RECOMMEND_POSTS: process.env.NEXT_PUBLIC_CLAUDE_ARTICLE_RECOMMEND_POSTS || false, // 文章详情底部显示推荐
  ...
  // GitHub 侧栏资料卡配置
  CLAUDE_PROFILE_AVATAR: process.env.NEXT_PUBLIC_CLAUDE_PROFILE_AVATAR || 'https://github.com/TerryZoom', // 头像URL；留空则回退到 AVATAR/siteInfo.icon
