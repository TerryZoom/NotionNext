...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小幺鸭TerryDuck', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '深度学习、AIGC、游戏、像素艺术的四灵根散修，不专业的人工智能本科生，分享自己的学习、创作与生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '86601125.xyz', // 网站地址
